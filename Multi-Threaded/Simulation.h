...
public:
	...
	int runOneIteration(sf::RenderWindow &window, sf::Time &elapsed, double gravConst = 10.0);		//calculates the new acceleration, velocity, and position for each body, and updates everything
...
private:
	...
	//std::vector<int> erasePlanets;
	//std::vector<Body> addPlanets;
