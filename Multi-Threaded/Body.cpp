...
double Body::getxPosition()
{
	return xPosition;
}

double Body::getyPosition()
{
	return yPosition;
}
...
double Body::getxAccel()
{
	return xAccel;
}

 double Body::getyAccel()
{
	return yAccel;
}

 void Body::setxAccel(double givenxAccel)
{
	xAccel = givenxAccel;
}
void Body::setyAccel(double givenyAccel)
{
	yAccel = givenyAccel;
}
